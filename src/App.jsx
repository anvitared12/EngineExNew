...
const App = ({ onLogout, onSettings, onNotifications }) => {
  ...
  useEffect(() => {
    const getUserData = () => {
      try {
        ...
        // Try to get token and decode if needed
        const token = localStorage.getItem('token') || sessionStorage.getItem('token');
        if (token) {
          // If you're using JWT, you might need to decode it
          // For now, we'll assume you have user data stored separately
  ...
  // Debug: let's see what's in storage
  useEffect(() => {
  ...
  // Temporary: Always show with fallback data for testing
